...
class TestWrapCacheStableKey:
    ...
    def test_truecolor_style_fingerprint_regression(self):
        ...
        assert f_true._wrap_cache[0] != f_int._wrap_cache[0]
