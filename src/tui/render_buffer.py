"""RenderBuffer 渲染缓冲区 — 二维字符网格，支持叠加合成。
...
class RenderBuffer:
    ...
    每格可存储字符（含 ANSI 转义序列），支持 Style 样式包裹。
    ...
    def hcenter(self, text: str, y: int, style: Style | None = None) -> None:
