...
实际实现已拆分到 tui_framework 的子模块：
  - tui_framework.core._wave.py   — 正弦波/呼吸/波动效果
  - tui_framework.core._sparkle.py — 闪烁/脉冲/高亮/辉光效果
  - tui_framework.core._train.py   — 列车/扫光/流动效果
  - tui_framework.core._compose.py — EffectRegistry 合成器与效果包装
...
# ── 从 framework 的拆分子模块重导出 ──
from tui_framework.core._wave import (
    sine_breath_t,
    sine_color,
    sine_color_range,
    bounce_easing,
...
from tui_framework.core._sparkle import (
    sparkle_brightness,
    sparkle_color,
    shimmer_position,
    shimmer_apply,
...
from tui_framework.core._train import (
    rainbow_color,
    build_rainbow_ansi,
    pulse_train,
...
from tui_framework.core._compose import (
    sine_easing,
    neon_color,
